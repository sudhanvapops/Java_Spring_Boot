...
public class ProductController {
    ...
    public ResponseEntity<byte[]> getImageByProductId(@PathVariable Long id) {
        return ResponseEntity
                ...
                .body(pService.getProductById(id).getImageData());
    }
    ...
    public ResponseEntity<?> addProduct(
        ...
        try {
            savedProduct = pService.addorUpdateProduct(product, imageFile);
            return ResponseEntity
    ...
    public ResponseEntity<?> updateProduct(
        ...
        try {
            updatedProduct = pService.addorUpdateProduct(product, imageFile);
            return ResponseEntity.status(HttpStatus.CREATED).body("Updated Succesfully: " + id + "\n" + updatedProduct);
        } catch (Exception e) {
            return ResponseEntity
                    .status(HttpStatus.INTERNAL_SERVER_ERROR)
                    .body(e.getMessage());
